...
class Network(object):
    ...
    def __init__(self, sizes, cost=CrossEntropyCost, reg=L2_Regularisation):
    ...
    def update_mini_batch(self, mini_batch, eta, lmbda, n):
        ...
        self.weights = [w-self.regularise.update_weight(n, eta, lmbda, w) \
    ...
    def total_cost(self, data, lmbda, convert=False):
        ...
        cost += sum(self.regularise.get_cost(len(data), lmbda, w) for w in self.weights)
        return cost
    ...
    def save(self, filename):
        ...
        data = {"sizes": self.sizes,
                ...
                "regularisation": str(self.regularise.__name__)}
        f = open(filename, "w")
        json.dump(data, f)
        f.close()
...
def load(filename):
    ...
    reg = getattr(sys.modules[__name__], data["regularisation"])
    net = Network(data["sizes"], cost=cost, reg=reg)
